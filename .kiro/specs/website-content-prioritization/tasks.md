...
- [x] 8. Increase retrieval result count
  - Modify `process_chat_request()` to request 60 results instead of 40
...
- [x] 9. Test and deploy
  ...
  - Test with "How do I sign up for a classroom pizza party?" query
  - Test with "pizza" (short query)
